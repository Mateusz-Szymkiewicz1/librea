  ...
  return (
    <>
      ...
      <>
        {waiting.length > 0 &&
          <>
          <div className="mx-2 sm:mx-5 shadow-lg bg-neutral-700 h-16 !mt-10 flex justify-between items-center sm:p-5 p-3 text-lg sm:text-xl">
          ...
          {showWaiting && waiting.map(el => {
            return(
              <div key={el.id} className="flex shadow-lg bg-neutral-600 text-white p-3 hover:bg-neutral-500 mx-2 sm:mx-5 mb-1 mt-1">
        ...
        <div className="bg-neutral-700 shadow-lg h-full w-full p-5">
          ...
          <button onClick={submit} className='shadow bg-blue-600 text-white px-10 text-lg p-3 mt-5 block hover:bg-blue-700'><i className="fa fa-send mr-2"></i>Submit a new author</button>
        </div>
      </div>
